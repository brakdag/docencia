...
\begin{document}
  \begin{longtable}{|p{3cm}|p{13cm}|p{5cm}|p{5cm}|}  \hline
         ...
         PRINCIPIOS Y FENÓMENOS FLUIDO-DINÁMICOS & 
         \begin{itemize}
...
\end{itemize}
    ...
    & \estrategias & \evaluacion \\ \hline
         INSTALACIONES Y EQUIPOS OLEO-HIDRAULICOS E HIDRÁULICOS & 
          \begin{itemize}
...
de seguridad correspondientes.
    ...
    \end{itemize}
        & \estrategias & \evaluacion \\ \hline
        INSTALACIONES Y EQUIPOS NEUMÁTICOS.  &
 \begin{itemize}
    ...
    \end{itemize}
    & \estrategias & \evaluacion \\ \hline
         ELEMENTOS DE MEDICIÓN Y ENSAYOS.  &
         \begin{itemize}
