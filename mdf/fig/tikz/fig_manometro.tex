...
\begin{tikzpicture}[
  ...
  \draw[dashed] (-0.5, 0.5) -- (4, 0.5) node[right, font=\small] {N}
  node[left=4.5cm, font=\small] {M};
  \draw[dashed] (-1, 3.5) -- (2, 3.5); % Nivel de A
  \draw[dashed] (2.7, 5) -- (4, 5); % Nivel de D

  % 6. Cotas de altura
  \draw[dim_line] (1.5, 0.5) -- (1.5, 3.5) node[midway, fill=white,
  inner sep=2pt] {$h_1$};
  \draw[dim_line] (3.5, 0.5) -- (3.5, 5) node[midway, fill=white,
  inner sep=2pt] {$h$};
  ...
  \draw[-Stealth, thick] (2.5, 6.2) -- (2.5, 5.2) node[above=0.2cm,
  pos=0] {$p_a$};
