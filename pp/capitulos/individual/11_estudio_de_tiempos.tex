...
desarrollado otras metodologás para medir el trabajo, el método
...
calificado dedica a realizar una tarea especófica de acuerdo con una
norma de ejecución preestablecida. El Estudio de Tiempos es una de
estas técnicas.

\info{La medición del trabajo segñun la OIT (Organización
Internacional del Trabajo)}{La Medición del trabajo es la aplicación
  ...
  calificado en llevar a cabo una tarea definida efectuándola segñun una
...
rechazar el cambio en só mismo, sino que rechazan el cambio del cual
...
mala reputación, especialmente en los córculos sindicales.
...
\begin{enumerate}
  ...
  \item Repartir el trabajo dentro de los equipos con la ayuda de
    ...
    los procesos.
  \item Determinar el nómero de máquinas que puede atender un operario.
\end{enumerate}
...
equivalente al término Estudio de Tiempos, nos referónLamos a que el
...
\begin{enumerate}
  ...
  \item Examinar: Los datos registrados y el detalle de los elementos
    con sentido crótico para verificar si se utilizan los métodos y
...
segñun una norma de ejecución preestablecida.}
