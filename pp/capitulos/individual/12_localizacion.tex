...
y gastos durante el peródodo productivo.}
...
Pero tambión puede darse el caso de que para una determinada empresa,
...
\begin{enumerate}
  ...
  \item Cercanón del mercado. El proyecto para la nueva ubicación debe
  ...
  \item Costo, disponibilidad y topografón de terrenos. Es importante
    ...
    espacio o por factores no considerados como zonas sósmicas, terrenos
  ...
  \item  Estructura impositiva y legal. Algunos paóses o estados adoptan
    polóticas que promueven la instalación industrial en determinadas zonas y
  ...
  \item Disponibilidad de agua, energón eláctrica y otros suministros. La
    disponibilidad tanto de agua como de energón eláctrica suelen ser un
  ...
  \item Disponibilidad y confiabilidad de los sistemas de apoyo. Para
    ...
    servicios póblicos como facilidades habitacionales y educacionales,
    caminos-vón de acceso y calles, seguridad póblica, ambulancias,
...
\begin{enumerate}
  ...
  \item ¿Cómo influye la disponibilidad de infraestructura (agua,
    energón, transporte) en la decisión de localización?
