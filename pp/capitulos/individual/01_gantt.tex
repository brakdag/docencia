...
\begin{itemize}
  ...
  \item \textbf{Tiempos \textit{Early} y \textit{Last}:}
    \begin{itemize}
      ...
      \item \textit{Last} (Tardío): El momento más tarde en que
...
\subsection{B. Pasada hacia atrás (Tiempos Tardíos)}
...
\begin{enumerate}
  \item \textbf{Fin}: El $LF$ de la última actividad es igual a su $EF$ (duración total del proyecto).
...
\begin{enumerate}
  ...
  \item \textbf{Caso: Clima Cuyo S.R.L.}
    ...
    \begin{itemize}
      ...
      \item la actividad I es la última del proceso, realizándose
        después de H.
    \end{itemize}
