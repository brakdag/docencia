...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Comandos: línea, rectángulos, polígonos, copiar, pegar, recortar, rotar, espejar, trazar paralelas, empalmar líneas, borrar, extender una línea, escribir un texto, distancia, área, arcos, circunferencias.
        \item Editar un texto.
        \item Cargar distintos tipos de línea.
        \item Generar bloques.
        \item Insertar bloques.
        \item Nociones sobre manejo de capas, formas de acotar, impresión de trabajos.
    \end{itemize}
