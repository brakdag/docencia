...
la energía eléctrica se transforme en calor. 
...
\begin{itemize}
    ...
    \item \textbf{$\rho$} (rho): Resistividad eléctrica del material ($\Omega \cdot m$).
    \item \textbf{$L$}: Longitud del conductor en metros ($m$).
    \item \textbf{$A$}: Área de la sección transversal en metros cuadrados ($m^2$).
\end{itemize}
...
Donde $\alpha$ es el coeficiente de temperatura del material y $R_0$ es la resistencia a la temperatura de referencia $T_0$.
