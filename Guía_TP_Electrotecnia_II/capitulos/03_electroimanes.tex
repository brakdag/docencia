...
\img{images/03/electroiman}{Electroimán compuesto por una batería, un clavo y alambre de cobre esmaltado.}
...
\begin{enumerate}
    \item El electroimán de la figura tiene aire entre el núcleo y la armadura \emph{entrehierro} una inducción magnética de $B=0,4T$. Calcular la fuerza de atracción del electroimán $F$.
    \begin{center}
    ...
    \draw [ultra thick] (-1,7) --(-1,2.2)--(0,1.2)--(1,1.2)--(1,5)--(4,5)--(4,1.2)--(5,1.2);
...
\end{center}
    ...
    \item Calcular la fuerza con la que el electroimán de superficie de atracción de $S=96cm^2$ atraerá a su armadura si la inducción magnética en el hierro es de $B=500Gs$.
    \item El circuito magnético de la figura está construido de fundición de hierro y en el \emph{entrehierro} se desea una inducción magnética $B=1T$. Calcular el valor de la intensidad de la corriente $I$, que debe circular por la bobina de $N=1000$ espiras considerando que ningún flujo se dispersa fuera del circuito. 
    
    \begin{center}
    \begin{tikzpicture}
    \path  [fill=gray](0,0)--(5,0)--(5,3)--(4,3)--(4,1)--(1,1)--(1,6)--(4,6)--(4,4)--(5,4)--(5,7)--(0,7)--(0,0);
    ...
    \item El anillo cilíndrico de la figura de sección $S=5cm^2$ está construído de chapa magnética, se desea un flujo de $\Phi =75000Mx$. Calcular la inducción magnética en el núcleo, longitud de la línea media y amperios -vuelta necesarios.
    \begin{center}
    ...
    \item El circuito de la figura está construído de chapa magnética, se desea una inducción de $B=1,8T$. Calcular la intensidad de campo $H$ en el hierro, longitud de la línea media, amperios-vuelta necesarios, intensidad que circula por la bobina de $N=200$ espiras.
\begin{center}
\begin{tikzpicture}[scale=0.03]
