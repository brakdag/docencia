...
\usepackage{subfiles,afterpage,fancyhdr,geometry,tikz,enumitem,longtable,comment,setspace}
\geometry{
 a4paper,
 landscape,
 left=10mm,
...
\begin{tikzpicture}[remember picture,overlay]
    \draw (23,-3.5) node {\includegraphics[scale=0.4]{images/4124.png}};
\end{tikzpicture}
\center{
...
\end{itemize}&  \evaluacion & \recursos \\ \hline
