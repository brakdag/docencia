...
\begin{itemize}
\item $\boxtimes$ Observación $\quad$ $\boxtimes$ Identificación $\quad$ $\square$ Comparación $\quad$ $\square$ Análisis
\item $\square$ Resumen $\quad$ $\square$ Síntesis $\quad$ $\square$ Clasificación $\quad$ $\boxtimes$ Interpretación
