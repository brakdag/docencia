...
\newcommand{\calrange}[3]{%
  ...
  [days={fill=green!50, rectangle, inner sep=2pt}]
  if (equals=\the\year-#1-#2) [days={fill=red!50, rectangle, inner sep=2pt}]
  if (equals=\the\year-#1-#3) [days={fill=red!50, rectangle, inner sep=2pt}];
}
