...
\begin{document}
\chapter{Fórmulas equivalencias y unidades}
\section{Fórmulas}
\subsection{Relación entre rotación, frecuencia y número de pares de
polos en máquinas síncronas.}
...
\begin{center}
  \begin{table}[h]
    ...
    \begin{tabular}{|r|c|c|}\hline
      ...
      Reactancia Capacitiva & $X_C=\frac{1}{2 \pi f C} $ & Ohm
      ($\Omega$)\\\hline
      Caballo de Vapor & $1CV = 736W$& CV (siempre es potencia activa) \\
      Caballo de Fuerza & $1HP = 746W$& HP (siempre es potencia
      activa) \\ \hline
      Resist. equiv. paralelo & $R_E =
      \frac{1}{\frac{1}{R_1}+\frac{1}{R_2}+...+\frac{1}{R_N}}$&
      Ohm($\Omega$) \\
